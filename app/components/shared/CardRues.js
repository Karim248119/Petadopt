    ...
    <div className="card5 rounded-2xl group">
      <div className="face1 rounded-2xl">
        <img
          ...
          src="https://images.pexels.com/photos/16577560/pexels-photo-16577560/free-photo-of-cat-lying-down.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
        ></img>
      </div>
      <div className="face2 capitalize rounded-t-2xl group-hover:rounded-2xl transition-[4s]">
        ...
        <p>
          ...
          praesentium alias eligendi distinctio! Recusandae voluptatibus quam
          numquam ducimus nemo nostrum, repellendus obcaecati
        </p>
